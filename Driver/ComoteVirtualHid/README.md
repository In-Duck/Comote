...
- A disposable Windows 11 x64 development VM
...
The wrapper refuses unrecognized physical machines, Windows Server, non-Windows
11 systems, and non-x64 systems. It records a JSON report under
