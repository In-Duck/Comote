...
if ($env:OS -ne "Windows_NT") {
    throw "Phase 2 VM validation can run only on Windows."
}
...
$buildScript = Join-Path $PSScriptRoot "Build-Phase2.ps1"
if (-not (Test-Path -LiteralPath $buildScript -PathType Leaf)) {
    throw "Build-Phase2.ps1 was not found."
}

$reportDirectory = Join-Path $PSScriptRoot "artifacts\phase2-reports"
...
Write-Host ""
Write-Host "Phase 2 VM build gate passed." -ForegroundColor Green
