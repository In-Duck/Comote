...
$updateManifest = [ordered]@{
    version = "1.6.0.24"
    client_package_url = "https://github.com/In-Duck/Comote/releases/download/v1.6.0-preview.24/ComoteClient-1.6.0-preview.24-win-x64.zip"
