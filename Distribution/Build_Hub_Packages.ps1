...
$updateManifest = [ordered]@{
    version = "1.6.0.27"
    client_package_url = "https://github.com/In-Duck/Comote/releases/download/v1.6.0-preview.27/ComoteClient-1.6.0-preview.27-win-x64.zip"
